...
<?php } else { ?>
  ...
  <div class="container"> 
    <div class="well">
      <h6 style=" margin-top: 25px; font-size: 40px;color: #DC143C; text-align: center;">Todos los Usuarios Dados De Baja</h6>
    </div>  

    <a type="button" class="btn btn-success" href="<?php echo base_url('userlist'); ?>">Ver activos</a>
